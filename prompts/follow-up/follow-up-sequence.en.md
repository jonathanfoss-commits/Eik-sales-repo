---
id: follow-up-sequence-en
title: Follow-up Sequence (English variant)
stage: follow-up
inputs: [prospect_name, context, last_touch, touch_number, new_value]
version: 1
lang: en
primary: follow-up-sequence.md
---

> **English variant.** Norwegian (Bokmål) is the default — see [`follow-up-sequence.md`](follow-up-sequence.md).
