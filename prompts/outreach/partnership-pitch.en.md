---
id: partnership-pitch-en
title: Partnership / Collaboration Pitch (English variant)
stage: outreach
inputs: [partner_name, partner_company, partner_type, shared_value, proposed_collaboration, call_to_action]
version: 1
lang: en
primary: partnership-pitch.md
---

> **English variant.** Norwegian (Bokmål) is the default — see [`partnership-pitch.md`](partnership-pitch.md).
> Use only for international partners. Per [ADR 0001](../../docs/decisions/0001-sprakpolicy.md).
